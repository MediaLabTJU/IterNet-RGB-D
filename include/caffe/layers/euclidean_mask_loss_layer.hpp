#ifndef CAFFE_EUCLIDEAN_MASK_LOSS_LAYER_HPP_
#define CAFFE_EUCLIDEAN_MASK_LOSS_LAYER_HPP_
 ...
 * input to a EuclideanMaskLossLayer exactly formulates a linear least squares
...
class EuclideanMaskLossLayer : public LossLayer<Dtype> {
 public:
 ...
 protected:
   ...
   *
   * Unlike other children of LossLayer, EuclideanMaskLossLayer \b can compute
